...
extension API: APIProtocol {
    ...
    var task: Request {
        ...
        case .updateProfile(let model):
            ...
            mutliPartFormData.add(key: "date_of_birth", value: model.date_of_birth ?? "")
            mutliPartFormData.add(key: "notes", value: model.notes ?? "")
            mutliPartFormData.add(key: "profile_image", fileName: "\(UUID().uuidString).jpeg", fileMimeType: "image/jpeg", fileData: model.profile_image ?? Data())
    ...
    var header: [String : String] {
        switch self {
        case .updateProfile:
            return ["Authorization":"260DJKzEpojzElPlnc9i2pwshXZsmF83MvdmesfIcJglLSyVYes4eqT58v2GdmQ2IdQrKTbLPEdvqicxgVzkxuymQDTrvGwIihuEJDVCWq7JH"]
        }
    }
}
